...
data = {'date' : None,
        'studio_info' : {
            'name' : 'Roomlight',
            'adress' : 'Монастырская, 12',
            'phone' : '+7 (993) 512-16-48',
            'website' : 'https://vk.com/roomlightart',
            'workschedule' : {
                'start' : '10:00',
                'finish' : '23:00'
            },
...
async def get_schedule(date: datetime.date) -> json:
    data['date'] = str(date)
    urls_dict = {
        f'https://appevent.ru/widget/api/event/freetimes?widget_key=41f111a6e593f173bcd60eade49bfba1&hall_id=2568&order_type=&company_id=1741&date={str(date)}' : 'WHITE'
    }
    responses = []
